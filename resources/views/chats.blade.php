        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu-one" class="sidebar-menu-one">
                    <ul>
                        <li class="chats-add">
                            <h4>Chats<a href="javascript:;" data-bs-toggle="modal" data-bs-target="#add-contact"><i
                                        class="feather-plus"></i></a></h4>
                        </li>
                        <li>
                                            ...
                                            <div class="media-body flex-grow-1">
                                                ...
                                                <div class="msg-box">
                                                    <div class="message-sub-box">
                                                        <div class="user-dot-blk">
                                                            ...
                                                            <div class="drop-item chat-dot-list">
                                                                <a href="#" data-bs-toggle="dropdown"
                                                                    aria-expanded="false" class="dot-icon">
                                                        ...
                                                        <span>11:35 AM <img src="assets/img/icon/read-check.svg"
                                                                alt></span>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form
                        action="https://dreamschat.dreamstechnologies.com/template-html/template-videocall/new-friends">
                    ...
                    <div class="form-row profile_form text-end float-end m-0 align-items-center">
                        <div class="newgroup_create">
                            <button type="button" class="btn btn-primary mb-0" data-bs-dismiss="modal"
                                aria-label="Close">
                                Add to contacts
                            </button>
                        </div>
